...
<body>
	...
	<div class="container">
		...
		<div id="instructions" class="jumbotron">
			...
			<?php } else { ?>
				<h2>Enigma Box Game</h2>
				  	<p>The enigma box is controlled by some hidden rules,</p>
				  	<p>your goal is to discover the rules by trial and error.</p>
				  	<p> <br> </p>
				  	<p>On each trial you will see some images within a grid.</p>
				  	<p>Different combinations of images and buttons can have different values.</p>
