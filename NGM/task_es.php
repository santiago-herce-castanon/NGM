...
<body>
	...
	<div class="container">
		...
		<div id="instructions" class="jumbotron">
			<?php if (!$loggedIn) { ?>
				<p>Por favor, <a href="./index.php">inicia sesión</a> antes de empezar.</p>
			<?php } else { ?>
				<h2>La Caja Enigma</h2>
				  	<p>La Caja Enigma está controlada por reglas ocultas.</p>
				  	<p> Tu objetivo es descubrir las reglas a través de ensayo y error.</p>
				  	<p> <br> </p>
				  	<p>En cada ensayo verás algunas imágenes dentro de una cuadrícula.</p>
				  	<p>Distintas combinaciones de imágenes y botones tienen diferentes valores.</p>
				  	<p>Responde apretando los botones(los círculos a la derecha e izquierda de la cuadrícula) para colectar puntos con cada imagen.</p>
				  	<p> <br> </p>
				  	<p>Resuestas correctas te ayudan a llenar tu barra de éxito. Cada vez que llenas tu barra de éxito, ganas una moneda virtual.</p>
					<p>Pierdes tus monedas cuando haces una respuesta incorrecta.</p>
				  	<p>Cuando colectas las 4 monedas accedes al siguiente nivel dell juego.</p>
				  	<p> <br> </p>
				  	<p>Intenta llegar al nivel más alto que puedas!</p>
				  	<p></p>
			  	<p>Comienza cuando quieras</p>
		...
		<div id="task">
			...
			<button id="trial-button" class="btn btn-lg btn-default">Iniciar nuevo ensayo</button>


			<div id="info">
				<div id="score">Score: <span id="current-score">0</span> <span id="added-points"></span></div>
				<div id="LevelNum"> <span id="levelnum-msg"> Nivel: 1</span></div>
				<div id="timer"><span id="timer-text">00:00</span></div>
			</div>

			<div id="options">
				<button id="pause-button" class="btn btn-default">Pausar</button>
		...
		<div class="jumbotron" id="end-div">
				...
				<p id="new-high-score-msg"><em>Obtuviste un nuevo score más alto!</em></p>

				<p id="current-high-score-msg">Tu score más alto:<br/>
					<span id="current-high-score" class="score-class"></span></p>
				<p id="previous-high-score-msg">Tu score más alto previamente: <br/>
    	...
    	<div class="modal-dialog">
			...
			<div class="modal-content">
		    	<div class="modal-header">
					<h4 class="modal-title">Nivel Completado</h4>
				</div>
				<div class="modal-body">
					<p id="levelup-msg">Wow! Parece que resolviste este nivel.</p> 
					<p>Haz click en el botón para pasar a siguiente nivel.</p>
				</div>
				<div class="modal-footer">
					<button type="button" id="levelup-button" class="btn btn-default" data-dismiss="modal">Comenzar siguiente nivel</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="Toggle-modal" role="dialog">
    	<div class="modal-dialog">
			...
			<div class="modal-content">
		    	<div class="modal-header">
					<h4 class="modal-title">Uy!</h4>
				</div>
				<div class="modal-body">
					<p id="toggle-msg">Parece que te está costando trabajo resolver este nivel</p> 
					<p>Siempre puedes hacer click en un cuadrado para hacerlo cambiar</p>
					<p>(pero pierdes las monedas que hayas acumulado)</p>
				</div>
				<div class="modal-footer">
	...
	<div class="modal fade" id="pause-modal" role="dialog">
    	<div class="modal-dialog">
			...
			<div class="modal-content">
		    	<div class="modal-header">
					<h4 class="modal-title">Juego Pausado</h4>
				</div>
				<div class="modal-body">
					<p id="idle-msg">Parece que dejaste de jugar así que pausamos el juego por ti.</p> 
					<p>Haz click en Continuar cuando quieras seguir jugando</p>
				</div>
				<div class="modal-footer">
					<button type="button" id="resume-button" class="btn btn-default" data-dismiss="modal">Continuar</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="trial-modal" role="dialog">
    	<div class="modal-dialog">
			...
			<div class="modal-content">
		    	<div class="modal-header">
					<h4 class="modal-title">Faltan unos cuantos ensayos!</h4>
				</div>
				<div class="modal-body">
					<p>Ya jugaste el tiempo requerido, por favor finaliza los ensayos que quedan en el contador antes de finalizar la sesión.</p>
				</div>
				<div class="modal-footer">
